...
import edu.umkc.Analytics.GeoLocationStats;
import edu.umkc.Analytics.WeeklyAnalytics;

@WebServlet("/GeoLocationStats")
public class GeoLocationServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getLogger(GeoLocationServlet.class.getName());
	...
	protected void doWork(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.println(GeoLocationStats.getGeoLocationStats());

...
public class BrandTweetCounts {
	...
	private static final String query = "select brand, count(*) from (select regexp_extract(text, 'Adidas|Nike|Puma|Skechers|Reebok', 0) as brand FROM tweets where text is not null) group by brand";
